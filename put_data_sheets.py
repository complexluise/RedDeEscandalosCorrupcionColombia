...
for filename in list_files:
    ...
    try:
        ...
        with open(
            "data/extracted_relations/" + filename, "r", encoding="utf-8"
        ) as file:
        ...
        with open(
            "data/processed_article/" + f"{escandalo}/" + filename,
            "w",
            encoding="utf-8",
        ) as file:
            file.write(json.dumps(json_news))
            LOG.info(
                "File saved in: %s", f"data/processed_article/{escandalo}/" + filename
            )
