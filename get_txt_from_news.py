...
bool_mask = (df_links_raw["Relaciones Extraidas"] == "TRUE") | (
    df_links_raw["Text Minado"] == "TRUE"
)
...
df_links_to_process = df_links_to_process_filtered.dropna(
    subset=["Fuente", "Escandalo", "Link", "Titulo"]
)
...
for index, row in df_links_to_process.iterrows():
    ...
    pages_indicator = {
        "asuntoslegales": {
            "html_tag": "div",
            "indicator": {"class": "postContent cell"},
        },
        ...
        "caracoltv": {
            "html_tag": "div",
            "indicator": {"class": "RichTextArticleBody-body RichTextBody"},
        },
        "elcolombiano": {"html_tag": "div", "indicator": {"class": "noticia"}},
        "elespectador": {"html_tag": "article"},
        "elpaís": {
            "html_tag": "div",
            "indicator": {"class": "paywall", "data-index": "0"},
        },
        ...
        "noticiasrcn": {
            "html_tag": "div",
            "indicator": {"class": "col-md-11 col-sm-12 text-note"},
        },
        # "wikipedia": {"html_tag": "div", "indicator": {"class": "mw-parser-output"}},
        "publimetro": {
            "html_tag": "article",
            "indicator": {
                "class": "default__ArticleBody-xb1qmn-2 dwgCRL article-body-wrapper"
            },
        },
        ...
        "radionacional": {
            "html_tag": "div",
            "indicator": {"class": "rnal_articulo_contenido_adicional container"},
        },
    ...
    try:
        ...
        # save file to txt
        with open(
            "data/raw_article/" + item["Fuente"] + "_" + filename + ".json",
            "w",
            encoding="utf-8",
        ) as file:
